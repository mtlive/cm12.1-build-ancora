...
#Archidroid v4.1
curl -L -O https://github.com/ArchiDroid/android_build/commit/f9b983e8e11624b48ae575da206f1baf6979772c.patch
sed -i 's/#\sARCHIDROID_GCC_CFLAGS\s+=\s-floop-block/ARCHIDROID_GCC_CFLAGS += -floop-block/' f9b983e8e11624b48ae575da206f1baf6979772c.patch
git apply f9b983e8e11624b48ae575da206f1baf6979772c.patch --directory=build
...
find out/target/ -iname "*.so" -exec tar -rvf chromium-libs.tar {} \;
curl --upload-file ./chromium-libs.tar https://transfer.sh
